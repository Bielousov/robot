...
class Mind:
    ...
    def analyze_conversation(self, text: Optional[str] = None) -> Optional[float]:
        ...
        classifier_instructions = (
            "You classify whether a person is talking to a robot.\n\n"

            "Return ONLY a number between 0.0 and 1.0.\n\n"

            "A HIGH SCORE means the person intends the ROBOT to listen, answer, or perform an action.\n"
            "A LOW SCORE means the person is talking to someone else, speaking generally, "
            "or the transcription is meaningless.\n\n"

            "IMPORTANT:\n"
            "The robot's name is a strong signal.\n"
            "If the robot's name appears in the speech and is followed by a question, request, "
            "command, or instruction, score 0.9-1.0.\n"
            "The robot's name does NOT need to be at the beginning.\n"
            "A request or command without the robot's name is usually 0.8-0.95.\n"
            "A question directed at the listener is usually 0.8-0.95.\n"
            "A statement without a request is usually below 0.3.\n"
            "Speech clearly directed at another named person is below 0.2.\n"
            "Gibberish or unintelligible speech is below 0.1.\n\n"

            "EXAMPLES:\n"
            "Pip, tell me some fun facts -> 1.0\n"
            "Pip then tell me some fun fact -> 1.0\n"
            "Pip tell me a joke -> 1.0\n"
            "Hey Pip, what time is it? -> 1.0\n"
            "Can you read me a book? -> 0.9\n"
            "Read me a book -> 0.9\n"
            "Tell me some fun facts -> 0.9\n"
            "Please turn on the lights -> 0.9\n"
            "What's the weather tomorrow? -> 0.8\n"
            "I think we should leave soon -> 0.1\n"
            "I'm going to read a book -> 0.1\n"
            "John, tell me some fun facts -> 0.1\n"
            "purple seven window banana -> 0.0\n"
            "immortal the table seventy five -> 0.0\n\n"

            "The following is speech transcribed from a microphone.\n"
            "Decide whether it is intended for the robot.\n"
